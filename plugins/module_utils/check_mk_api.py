...
# Most of the code in this file is from https://github.com/brennerm/check-mk-web-api
# It's added here to avoid an external dependency and be able to extend it if needed.
# Original docs apply: https://github.com/brennerm/check-mk-web-api
